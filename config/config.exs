...
config :firmware_manager, FirmwareManagerWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: FirmwareManagerWeb.ErrorHTML, json: FirmwareManagerWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: FirmwareManager.PubSub,
  live_view: [signing_salt: "2GlFXyB/"]
...
config :firmware_manager, FirmwareManager.Mailer, adapter: Swoosh.Adapters.Local
...
# Configure the Modem domain for Ash
config :firmware_manager, FirmwareManager.Modem,
