...
#
#     PHX_SERVER=true bin/firmware_manager start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :firmware_manager, FirmwareManagerWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/firmware_manager/firmware_manager.db
      """
  ...
  #
  #     config :firmware_manager, FirmwareManager.Mailer,
