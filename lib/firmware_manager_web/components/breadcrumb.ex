defmodule FirmwareManagerWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `FirmwareManagerWeb.Components.Breadcrumb` component for displaying
