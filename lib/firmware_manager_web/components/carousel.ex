defmodule FirmwareManagerWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `FirmwareManagerWeb.Components.Carousel`
  project.
