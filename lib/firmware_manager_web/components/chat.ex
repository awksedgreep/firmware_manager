defmodule FirmwareManagerWeb.Components.Chat do
  @moduledoc """
  `FirmwareManagerWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
