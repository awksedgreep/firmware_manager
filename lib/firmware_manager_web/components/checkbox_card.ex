defmodule FirmwareManagerWeb.Components.CheckboxCard do
  @moduledoc """
  The `FirmwareManagerWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
