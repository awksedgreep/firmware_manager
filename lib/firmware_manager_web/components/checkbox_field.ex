defmodule FirmwareManagerWeb.Components.CheckboxField do
  @moduledoc """
  FirmwareManagerWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
