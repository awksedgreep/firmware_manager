defmodule FirmwareManagerWeb.Components.Combobox do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
  ...
  use Gettext, backend: FirmwareManagerWeb.Gettext
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FirmwareManagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FirmwareManagerWeb.Gettext, "errors", msg, opts)
    end
  end
