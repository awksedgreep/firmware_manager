defmodule FirmwareManagerWeb.Components.DeviceMockup do
  @moduledoc """
  The `FirmwareManagerWeb.Components.DeviceMockup` module provides a customizable component for displaying
