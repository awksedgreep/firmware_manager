defmodule FirmwareManagerWeb.Components.Divider do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `FirmwareManagerWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
