defmodule FirmwareManagerWeb.Components.Drawer do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Drawer` module provides a flexible and customizable drawer component
