defmodule FirmwareManagerWeb.Components.FileField do
  @moduledoc """
  The `FirmwareManagerWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import FirmwareManagerWeb.Components.Progress, only: [progress: 1]
