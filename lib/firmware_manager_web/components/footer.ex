defmodule FirmwareManagerWeb.Components.Footer do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
