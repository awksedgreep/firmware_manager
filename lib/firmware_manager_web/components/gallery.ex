defmodule FirmwareManagerWeb.Components.Gallery do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Gallery` module provides a customizable gallery component for displaying
