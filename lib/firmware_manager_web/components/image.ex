defmodule FirmwareManagerWeb.Components.Image do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
