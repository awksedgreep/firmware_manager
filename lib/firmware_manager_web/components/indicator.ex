defmodule FirmwareManagerWeb.Components.Indicator do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Indicator` module provides a versatile component for visually highlighting
