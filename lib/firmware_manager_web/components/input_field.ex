defmodule FirmwareManagerWeb.Components.InputField do
  @moduledoc """
  The `FirmwareManagerWeb.Components.InputField` module provides a customizable input field component that
