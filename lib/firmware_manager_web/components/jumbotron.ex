defmodule FirmwareManagerWeb.Components.Jumbotron do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Jumbotron` module provides a versatile component for creating large,
