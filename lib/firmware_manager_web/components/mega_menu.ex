defmodule FirmwareManagerWeb.Components.MegaMenu do
  @moduledoc """
  The `FirmwareManagerWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
