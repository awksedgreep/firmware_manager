defmodule FirmwareManagerWeb.Components.Menu do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `FirmwareManagerWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import FirmwareManagerWeb.Components.Accordion, only: [accordion: 1]
  import FirmwareManagerWeb.Components.Button, only: [button_link: 1]
