defmodule FirmwareManagerWeb.Components.Modal do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Modal` module provides a versatile and customizable modal component for
