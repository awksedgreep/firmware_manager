defmodule FirmwareManagerWeb.Components.NativeSelect do
  @moduledoc """
  The `FirmwareManagerWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `FirmwareManagerWeb.Components.NativeSelect`
