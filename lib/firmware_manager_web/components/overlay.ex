defmodule FirmwareManagerWeb.Components.Overlay do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `FirmwareManagerWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
