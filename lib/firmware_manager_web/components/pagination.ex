defmodule FirmwareManagerWeb.Components.Pagination do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Pagination` module provides a comprehensive and highly customizable
