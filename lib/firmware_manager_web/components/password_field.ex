defmodule FirmwareManagerWeb.Components.PasswordField do
  @moduledoc """
  The `FirmwareManagerWeb.Components.PasswordField` module is a Phoenix component designed to render a customizable
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      ...
      Gettext.dgettext(FirmwareManagerWeb.Components.PasswordField.Gettext, "errors", msg, opts)
    end
  end
