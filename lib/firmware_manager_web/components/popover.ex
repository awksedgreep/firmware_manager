defmodule FirmwareManagerWeb.Components.Popover do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
