defmodule FirmwareManagerWeb.Components.Progress do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Progress` module provides a customizable progress bar component for
