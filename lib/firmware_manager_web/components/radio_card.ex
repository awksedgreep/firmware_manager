defmodule FirmwareManagerWeb.Components.RadioCard do
  @moduledoc """
  The `FirmwareManagerWeb.Components.RadioCard` module provides a customizable radio card component for Phoenix LiveView
