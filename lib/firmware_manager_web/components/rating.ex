defmodule FirmwareManagerWeb.Components.Rating do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
