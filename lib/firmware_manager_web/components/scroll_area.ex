defmodule FirmwareManagerWeb.Components.ScrollArea do
  @moduledoc """
  The `FirmwareManagerWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
