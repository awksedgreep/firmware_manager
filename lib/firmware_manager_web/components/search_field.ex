defmodule FirmwareManagerWeb.Components.SearchField do
  @moduledoc """
  The `FirmwareManagerWeb.Components.SearchField` module provides a highly customizable search input
