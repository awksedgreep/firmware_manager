defmodule FirmwareManagerWeb.Components.Skeleton do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
