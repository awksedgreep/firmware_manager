defmodule FirmwareManagerWeb.Components.SpeedDial do
  @moduledoc """
  The `FirmwareManagerWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
