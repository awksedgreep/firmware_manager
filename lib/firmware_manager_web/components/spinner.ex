defmodule FirmwareManagerWeb.Components.Spinner do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `FirmwareManagerWeb.Components.Spinner` module enables developers to provide
