defmodule FirmwareManagerWeb.Components.Stepper do
  @moduledoc """
  The `FirmwareManagerWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `FirmwareManagerWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
