defmodule FirmwareManagerWeb.Components.TableContent do
  @moduledoc """
  `FirmwareManagerWeb.Components.TableContent` is a component module designed to create flexible and dynamic
