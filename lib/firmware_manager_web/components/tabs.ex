defmodule FirmwareManagerWeb.Components.Tabs do
  @moduledoc """
  `FirmwareManagerWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import FirmwareManagerWeb.Components.Badge, only: [badge: 1]
