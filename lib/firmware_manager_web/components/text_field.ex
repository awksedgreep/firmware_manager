defmodule FirmwareManagerWeb.Components.TextField do
  @moduledoc """
  The `FirmwareManagerWeb.Components.TextField` module provides a highly customizable text input field
