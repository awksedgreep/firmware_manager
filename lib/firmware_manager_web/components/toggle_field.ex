defmodule FirmwareManagerWeb.Components.ToggleField do
  @moduledoc """
  FirmwareManagerWeb.Components.ToggleField component renders a toggle field with customizable options.
