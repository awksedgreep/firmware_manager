defmodule FirmwareManagerWeb.Components.UrlField do
  @moduledoc """
  FirmwareManagerWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
